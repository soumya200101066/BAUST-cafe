...
<html>
  ...
  <head>
    <title> Manager Login | BAUST Cafe </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">BAUST Cafe</a>
        </div>
...
$sql = "SELECT * FROM orders o  join customer on o.username=customer.username  WHERE o.R_ID IN (SELECT r.R_ID FROM RESTAURANTS r WHERE r.M_ID='$user_check') ORDER BY order_ID";
